define('group/add-member', ['jquery', 'bootbox'], function($, bootbox) {
    var strLoading = '<div class="add-member-loading loading text-center"> <i class="fa fa-spinner fa-spin fa-2x"></i> </div>';

    var selector = {
        appHandler: '.app-add-member-opt'
        ,handler: '.add-member-opt'
    ...
    var url = {
        types: 'ajax/settings/member/get-add-member-types'
        ,addMember: 'ajax/settings/member/get-add-modal'
        ,search: 'ajax/settings/member/search'
        ,add: 'ajax/settings/member/post-add'
    };
